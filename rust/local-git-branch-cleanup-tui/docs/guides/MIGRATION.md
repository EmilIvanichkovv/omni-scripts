...
| **Branch Classification** | No remote only    | 7 status types         | Merged, pr-merged, pr-diverged, gone, unmerged, protected, current |
...
- Classifies: merged, pr-merged, pr-diverged, gone, unmerged, protected, current

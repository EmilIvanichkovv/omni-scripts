...
| **Branch Classification** | No remote only    | 8 status types         | Merged, pr-merged, pr-diverged, gone, unmerged, local, protected, current |
...
- Classifies: merged, pr-merged, pr-diverged, gone, unmerged, local, protected, current
